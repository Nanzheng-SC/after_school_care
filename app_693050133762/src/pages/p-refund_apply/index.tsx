...
const RefundApplyPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const mockRefundData: Record<string, OrderInfo> = {
      'enrollment1': {
        courseName: '数学思维训练',
        courseTime: '2024-01-20 14:00-16:00',
        paidAmount: '¥80.00',
      ...
      'enrollment2': {
        courseName: '创意绘画启蒙',
        courseTime: '2024-01-21 10:00-11:30',
        paidAmount: '¥60.00',
        refundAmount: '¥60.00'
      },
      'enrollment3': {
    ...
    if (enrollmentId && mockRefundData[enrollmentId]) {
      setOrderInfo(mockRefundData[enrollmentId]);
    }
  }, [searchParams]);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const submissionData = {
        enrollmentId: searchParams.get('enrollmentId') || 'enrollment1',
